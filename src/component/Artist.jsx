...
export default function Artist() {
  return (
    <>
      <div className="sm:grid  overflow-x-scroll sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6  h-56 overflow-y-hidden sm:overflow-hidden min-w-[100%] flex sm:w-full">
        {artists.map((artist) => (
